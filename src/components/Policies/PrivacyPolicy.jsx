...
const PrivacyPolicy = () => {
  return (
    <>
      ...
      <p>
        This privacy notice for Pixel Galaxies s.r.o ("Company," "we," "us," or
      ...
      <ul>
        <li>
          Visit our website at https://www.animhub.dev, or any website of ours
      ...
      <p>
        ...
        how you interact with Pixel Galaxies s.r.o and the Services, the choices
      ...
      <p>
        ...
        is by visiting https://www.animhub.dev/profile/[your username] {"->"}{" "}
        Edit profile, or by contacting us. We will consider and act upon any
        request in accordance with applicable data protection laws.
      </p>
      <p>
        Want to learn more about what Pixel Galaxies s.r.o does with any
      ...
      <ul>
        ...
        <li>7. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</li>
      ...
      <p>
        ...
        is stored by Stripe. You may find their privacy notice link(s) here:
      ...
      <p>
        ...
        Notice: https://www.animhub.dev/cookies.
      </p>
      ...
      <ul>
        ...
        <li>Google AdSense and Carbon Ads</li>
        <li>Allow Users to Connect to Their Third-Party Accounts</li>
        <li>Github account and Discord account</li>
      ...
      <p>
        ...
        please see our Cookie Notice: https://www.animhub.dev/cookies.
      </p>
      <p>
        If you have questions or comments about your privacy rights, you may
        email us at hello@www.animhub.dev.
      </p>
      ...
      <p>
        You may contact us by email at hello@www.animhub.dev, or by referring to
      ...
      <p>
        Pixel Galaxies s.r.o has not sold or shared any personal information to
        third parties for a business or commercial purpose in the preceding
        twelve (12) months. Pixel Galaxies s.r.o has disclosed the following
      ...
      <p>
        ...
        hello@www.animhub.dev, or by referring to the contact details at the
        bottom of this document. If you have a complaint about how we handle
        your data, we would like to hear from you.
      </p>
      <h2>13. DO VIRGINIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
      <p>
      ...
      <p>
        ...
        depending on how you interact with Pixel Galaxies s.r.o and our
      ...
      <p>
        Pixel Galaxies s.r.o has not sold any personal data to third parties for
        business or commercial purposes. Pixel Galaxies s.r.o will not sell
      ...
      <p>
        ...
        https://www.animhub.dev/cookies.
      </p>
      <p>
        You may contact us by email at hello@www.animhub.dev, by visiting
        https://www.animhub.dev/profile/[your username] {"->"} Edit profile, or
      ...
      <p>
        ...
        decision, please email us at hello@www.animhub.dev. Within sixty (60)
      ...
      <p>
        ...
        https://www.animhub.dev/profile/ {"->"} Edit profile.
      </p>
    </>
  );
};
